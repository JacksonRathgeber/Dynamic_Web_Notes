...
const ModalPage = () => {
  ...
  const actionBar = (
    <>
    <Button success outline onClick={handleCloseClick}>I Accept</Button>
    <Button danger outline onClick={handleCloseClick}>I Decline</Button>
    </>
);
  ...
  return (
    <div>
      ...
      {modalOpen && <Modal onClose={handleCloseClick} actionBar={actionBar}>
        This is a modal!
      </Modal>}
    </div>
  );
